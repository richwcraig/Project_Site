---
title: 2022 Registration Forecasting
...
description: This is a stroll through how I forecasted the 2022 Oregon Registrations.
---
...
Finally, I broke down and created a for loop to go through and pull out all the data for each district and create the five individual datasets. After this step, I could now actually forecast voter registration for the 2022 Midterm election.
...
```{r District 8 Final, include==FALSE}
TS<-District_SS08%>%
  as_tsibble()
...
```{r District 10 Final, include==FALSE}
TS<-District_SS10%>%
  as_tsibble()
...
```{r District 23 Final, include==FALSE}
TS<-District_SS23%>%
  as_tsibble()
...
```{r District 30 Final, include==FALSE}
TS<-District_SS30%>%
  as_tsibble()
...
```{r Creating Percentages, inlcude = FALSE}
...
```{r Senate District 7 Outcome, echo=FALSE}
