...
ggplot(Senate_Model,aes(x=pop_density,y=Growth))+
  ...
  labs(title="Growth of Nonaffiliated voters vs Population Density")

ggplot(Senate_Model,aes(x=house_density,y=Growth))+
  geom_point()+
  geom_smooth(method="lm")+
  labs(title="Growth of Nonaffiliated voters vs Housing Density")

ggplot(Senate_Model,aes(x=((pop_density+house_density)/2),y=Growth))+
  geom_point()+
  geom_smooth(method="lm")+
  labs(title="Growth of Nonaffiliated voters vs Average Density")

ggplot(Senate_Model,aes(x=white_per,y=Growth))+
  geom_point()+
  geom_smooth(method="lm")+
  labs(title="Growth of Nonaffiliated voters vs Percent of White Population")

ggplot(Senate_Model,aes(x=black_per,y=Growth))+
  geom_point()+
  geom_smooth(method="lm")+
  labs(title="Growth of Nonaffiliated voters vs Percent of Black Population")

ggplot(Senate_Model,aes(x=latinx_per,y=Growth))+
  geom_point()+
  geom_smooth(method="lm")+
  labs(title="Growth of Nonaffiliated voters vs Percent of Latinx Population")

ggplot(Senate_Model,aes(x=asian_per,y=Growth))+
  geom_point()+
  geom_smooth(method="lm")+
  labs(title="Growth of Nonaffiliated voters vs Percent of Asian Population")


ggplot(Senate_Model,aes(x=asian_per+latinx_per+black_per,y=Growth))+
  geom_point()+
  geom_smooth(method="lm")+
  labs(title="Growth of Nonaffiliated voters vs Combined Minorities")
