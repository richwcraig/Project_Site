...
```{r Statewide Graphs, fig.width=7, fig.height=5,echo=FALSE}
...
ggplot(statewide,aes(x=Date))+
  ...
  ylim(20,40)+
  geom_line(aes(y=Nonaffiliated_Per),color="darkblue")+
  labs(title="Growth of Non-affiliated Voters following the Motor Voter Act")+
...
### How will NAV registration look in 2022?
  ...
  To begin to investigate what is driving NAV growth and the political effect it will have on the state, five distinct Senate districts in this study highlight the diversity of Oregon politics and its many facets, shedding light on what NAVs look like in Oregon. Do keep in mind that these forecasts are dependent on these districts remaining the same after redistricting later this year -- the point of forecasting is to get a better sense of the state a whole and not to determine the specific makeup of each district.
...
### Who is driving NAV growth?
  ...
  What is causing this growth needs further investigation. But it is still super intersting to look at that growth. 
  
```{r gif, echo=FALSE, out.height="100%",out.width="100%"}
